    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus drum eksklusif dengan mentor profesional Eno Netral, fokus pada teknik, groove, dan improvisasi.", "img/Landing1.svg", true, "Kursus Drummer Special Coach (Eno Netral)", 8500000L, new Guid("d236d9db-5312-48d7-b171-a340c134f6f6"), null },
                    { 2, 1, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus drum untuk anak-anak, belajar ritme dasar, koordinasi tangan-kaki, dan bermain lagu sederhana.", "img/Landing4.svg", true, "Drummer for kids (Level Basic/1)", 2200000L, new Guid("633473ab-67d5-4460-9f9a-a8eef9be341d"), null },
                    { 3, 2, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Belajar piano dari dasar hingga mahir, termasuk teknik, sight-reading, dan repertoar klasik & modern.", "img/Landing5.svg", true, "Kursus Piano : From Zero to Pro (Full Package)", 11650000L, new Guid("250ef74f-6bec-4a29-b101-0d6ed27437ad"), null },
                    { 4, 2, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kuasai improvisasi piano jazz, belajar chord voicing, scales, dan bermain bersama band.", "img/Landing22.svg", true, "Piano Jazz Improvisation", 7000000L, new Guid("2cc98cec-0887-4171-bfeb-b23d68e6e9e1"), null },
                    { 5, 3, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus gitar pemula untuk anak-anak, fokus belajar chord dasar, petikan, dan lagu sederhana.Kursus gitar pemula untuk anak-anak, fokus belajar chord dasar, petikan, dan lagu sederhana.", "img/Landing2.svg", true, "[Beginner] Guitar class for kids", 1600000L, new Guid("602558bf-e45c-4ff5-80ac-c3f4fba1300e"), null },
                    { 6, 3, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Belajar teknik gitar rock, solo, power chord, dan riff untuk pemula hingga menengah.", "img/Landing33.svg", true, "Guitar Rock Techniques", 3500000L, new Guid("217cdf56-0c1c-419e-885c-302488474f13"), null },
                    { 7, 4, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus bass untuk pemula, belajar teknik dasar, groove, dan memainkan lagu sederhana.", "img/Landing44.svg", true, "Bass Fundamentals for Beginners", 2000000L, new Guid("ed415851-8d59-44bc-ad4c-c79cc871564e"), null },
                    { 8, 4, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Pelajari teknik lanjutan bass, termasuk slap, tapping, dan improvisasi untuk berbagai genre musik.", "img/Landing45.svg", true, "Advanced Bass Techniques", 4500000L, new Guid("ff17199d-6790-4052-b04b-96d3149b877c"), null },
                    { 9, 5, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus biola level menengah, belajar teknik bowing, vibrato, dan ekspresi musikal.", "img/Landing3.svg", true, "Biola Mid-Level Course", 3000000L, new Guid("1afb6912-52ff-46df-a8ac-feb53bfc7326"), null },
                    { 10, 5, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Belajar teknik lanjutan biola, interpretasi musik klasik, dan persiapan tampil di konser.", "img/Landing55.svg", true, "Violin Advanced Performance", 6000000L, new Guid("c1de03ce-528f-4d52-ab9e-bb156e3fc0c1"), null },
                    { 11, 6, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus menyanyi untuk pemula, fokus pada teknik pernapasan, kontrol nada, dan penguatan suara.", "img/Landing66.svg", true, "Vocal Training for Beginners", 2500000L, new Guid("1b507945-91bf-4904-ac4a-09a18d0e27d1"), null },
                    { 12, 6, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kuasai teknik vokal lanjutan, ekspresi musik, vibrato, dan performa panggung profesional.", "img/Landing66.svg", true, "Advanced Vocal Mastery", 5500000L, new Guid("ce44161a-a1e3-4fde-889a-dab9f1355e20"), null },
                    { 13, 7, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus flute pemula, belajar teknik embouchure, fingering, dan memainkan melodi sederhana.", "img/Landing67.svg", true, "Flute Basics for Beginners", 2200000L, new Guid("174bc8e5-e615-4877-b4c2-5202cc70e9d8"), null },
                    { 14, 7, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Pelajari teknik lanjutan flute, interpretasi musik, dinamika, dan ekspresi panggung.", "img/Landing77.svg", true, "Flute Performance & Expression", 4800000L, new Guid("20cd6469-d4c0-486f-84ee-0a3d9805b921"), null },
                    { 15, 8, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Kursus saxophone level expert, belajar improvisasi jazz, teknik embouchure, dan performa profesional.", "img/Landing6.svg", true, "Expert Level Saxophone", 7350000L, new Guid("039dfcd8-7258-4417-8359-5f47fbd44e18"), null },
                    { 16, 8, new DateTime(2022, 10, 25, 0, 0, 0, 0, DateTimeKind.Utc), "System", "Belajar teknik dasar hingga improvisasi jazz di saxophone untuk pemula hingga menengah.", "img/Landing88.svg", true, "Saxophone Jazz Essentials", 4500000L, new Guid("c3a3d793-bad8-4f3f-856e-b71de82deb2a"), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 25, 9, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("e8ad711c-43bd-43a2-98c6-3d46b3667812"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 26, 9, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("cbd109ea-3589-488a-bf07-668b46f6bc8a"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 27, 9, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("670e7315-12b0-4dda-8adb-34de699cf3be"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 28, 10, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("20ee3579-1c49-4e8f-8554-3a1ff11411e2"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 29, 10, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("7cceb84e-1fb3-4834-b594-903edb63e1a1"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 30, 10, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("5d4ab8e2-0383-4d71-9d70-9e1b6e86ec94"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 31, 11, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("26f85f8d-9f30-4b2d-88f1-1170c0cfd7bc"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 32, 11, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("c68ce666-4fb9-41f1-8823-cb5ef12a26ee"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 33, 11, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("fc1e014b-d804-45e6-b9e6-ca7cb863deee"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 34, 12, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("bacae46f-be78-4e4e-ad18-7050a9fcf125"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 35, 12, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("c9444095-c496-4a71-9e60-3932449f5f91"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 36, 12, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("7b89ba88-8d47-438b-938d-e4a6b207ee93"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 37, 13, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("0a5b10b7-5b2b-4323-99f7-d4016697b191"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 38, 13, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("7f10395a-f36e-455b-9dbc-7c39210d3ee6"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 39, 13, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("237fc072-5e2e-4f10-b980-0d18b889cab1"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 40, 14, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("b04045b4-13af-4d8c-921c-971e0c5cf904"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 41, 14, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("c244ef8a-3222-4002-be2b-d53a7fc6e787"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 42, 14, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("2bb5eaf0-f3a6-4842-a191-161cc51b4bf0"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 43, 15, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("c6666efa-2e35-4bac-810f-10e694a6d7db"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 44, 15, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("1083cf7b-d1ef-4953-901b-64c72ae82160"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 45, 15, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("4e0ad8cb-938d-4f9d-9786-34550d529dcc"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 46, 16, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 25), new Guid("db796688-95bb-4aa4-8a08-d846dd81e1d3"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 47, 16, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 26), new Guid("172ac710-0583-42f9-b27d-653fc99251cf"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 48, 16, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateOnly(2022, 10, 27), new Guid("5923917b-fefd-4525-aab3-12813aa6c41c"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
